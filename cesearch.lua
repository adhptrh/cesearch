...
function getCseToken()
  local ok = getInternet().getURL("https://cse.google.com/cse/cse.js?cx=009081794347989224031:rrizk45lqzi")
  return string.match(ok,"en.: .(.+)\".+is")
end

function CESearch(toSearch,page)
  local getUrl = getInternet().getURL
  page = page*10
  local cse_tok = getCseToken()
